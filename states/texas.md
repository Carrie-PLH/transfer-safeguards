...
**Grounds stated in the sources.** Seven bulleted bases in HHSC's Provider Letter PL 2022-25 (September 29, 2022): the facility "must allow a resident to remain in the facility and may not involuntarily discharge the resident unless" one of the stated circumstances applies — quoted in full in section 01. The rule cited by the letter is 26 TAC 554.502.

**Notice stated in the sources.** PL 2022-25: written notification "at least 30 days before the intended discharge date", with five stated as-soon-as-practicable circumstances; required contents quoted from 26 TAC 554.502 in HHSC's Fair and Fraud Hearings Handbook (Revision 25-3, Effective May 15, 2025).

**Hearing office in these sources.** The Texas Health and Human Services Commission itself: the notice must state the right "to appeal the discharge by requesting a hearing through the Health and Human Services Commission (HHSC) within 90 days", under HHSC's Uniform Fair Hearings rules (1 TAC Chapter 357, Subchapter A). The route runs through the appeal form the notice must describe; the evidence packet goes to the hearings officer "via the fax, email, or address listed on the hearing notice".
...
Five business days for the evidence packet — PL 2022-25, section 2.5: facilities are stated to be "encouraged to send it no less than five business days before the hearing date"; the letter states there are "no federal or state regulations regarding how far ahead of the hearing to send the packet".
...
What moved. HHSC's Forms and Handbooks system has left hhs.texas.gov for its own subdomain: the handbook address this page carried since 2026-08-30 now returns HTTP 403 to every transport tried, and the same document is served over plain curl at fhb.hhs.texas.gov. The Long-Term Care Ombudsman program has left the apps.hhs.texas.gov directory for its own site at ltco.texas.gov; the old directory address answers "You do not have permission to view this directory or page." Both old addresses are recorded here rather than quietly replaced, because a reader who saved this page in August needs to know why the link stopped working.

What changed in the text. The handbook has been revised from Revision 23-1 (Effective July 31, 2023) to Revision 25-3 (Effective May 15, 2025), and its quotation of 26 TAC Section 554.502 now reads differently in three spans this page quotes. "the resident or individuals in the facility" is now "the resident or person in the facility"; "assistance in completing the form" is now "assistance completing the form"; and "the name, address, email address, and telephone number of the managing local ombudsman" is now "the name, address, email address and phone number of the managing local ombudsman". The page quotes the current revision, and the superseded wording is stated here so the change is legible rather than invisible. Note for anyone tracing the other half of that sentence: this page's "submitting the fair hearing request" is quoted from PL 2022-25 and not from the handbook, which said "appeal hearing request" in both revisions.

The ombudsman program's telephone sentence changed shape as well as punctuation. It read "Call 1-800-252-2412 to speak with an LTC ombudsman in your area." as a complete sentence and now reads "Call 800-252-2412 to speak with an LTC ombudsman in your area, email our office, or look for an LTC ombudsman in your area." — the same number without the "1-" prefix, inside a longer sentence. The quoted span was re-cut to end where the published sentence continues, so it remains a contiguous run. "Services are free, confidential and available statewide." is unchanged.

Capture limitation, recorded as a limitation and not resolved. The two moved sources were re-captured mechanically into a supplement, tools/packets/texas-packet-moved.txt, rather than by rebuilding the main packet, because three of the main recipe's five sources need an agent transport this session could not complete: hhs.texas.gov refuses every non-browser client for PL 2022-25, and the Secretary of State's TAC portal renders only to a live browser. The evidence those three hold is unchanged from 2026-08-30 and remains in the main packet, which is why the page still verifies in full; the main packet was not rebuilt and its 2026-08-30 retrieval dates stand. What a later session should do is rebuild the main packet once all five sources can be captured in one pass.

Findings: (1) A source can move without being revised and be revised without moving; here the handbook did both and the ombudsman page did both, and each has to be checked separately, since a working URL is not evidence the text behind it is the text that was quoted. (2) The TAC portal now renders one rule per record where it rendered a subchapter summary in August, so reaching 26 TAC 554.502 and 554.503 takes two record IDs instead of one — recorded in tools/recipes/texas.json, with the rule body text still capture-pending as it has been since the page was built. Reviewer: Carrie Schluter (review pending before publication). Corrections: hello@fieldassembly.net.

2026-09-05 — Correction: the "five business days" quotation in section 02 read facilities "are encouraged to send it no less than five business days before the hearing date", quoting "are" as part of the sentence. Backfilling this page's capture recipe (tools/recipes/texas.json) found that PL 2022-25's own pagination breaks the sentence between "are" and "encouraged": the word "are" ends printed page 6, footnotes 12 and 13 sit at that page's foot, and "encouraged to send..." begins printed page 7 — real structure the 2026-08-30 hand capture's rendering tool had silently smoothed away, the same class of artifact CLAUDE.md's two-column-PDF note describes for Missouri. A recipe capture that respects the document's own page breaks cannot verify "are encouraged" as one contiguous span; the original hand capture's continuous rendering could, but only by eliding the page turn. Corrected to move "are" outside the quotation, so the quoted span ("encouraged to send it no less than five business days before the hearing date") is a verbatim, contiguous run inside a single printed page; no wording or meaning changed. Reviewer: Carrie Schluter (review pending before publication).
